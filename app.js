...
const STATE = {
  ...
  project: {
    ...
    systemDate: new Date().toLocaleDateString('en-CA'), // Dynamically fetch today's local date in YYYY-MM-DD format
...
const DEFAULT_MOCK_REGISTRATIONS = [
  ...
  { EmployeeID: "0005", FirstName: "วิรุฬห์", LastName: "ก้าวหน้า", Department: "คลังสินค้า", Phone: "511", Shift: "Team A", Goal: "เลิก", Target: "บุหรี่", Duration: "ตลอดชีวิต", Timestamp: "2026-07-04 10:12:35" },
...
function renderDashboardCharts() {
  ...
  STATE.charts.duration = new Chart(ctxDuration, {
    type: 'pie',
    data: {
      labels: ['1 เดือน', '2 เดือน', '3 เดือน', 'ตลอดชีวิต'],
      datasets: [{
        data: [countsDur.m1, countsDur.m2, countsDur.m3, countsDur.lifetime],
        backgroundColor: ['#fcd34d', '#fb923c', '#d97706', '#10b981'],
        borderWidth: 2
      }]
    },
    options: {
